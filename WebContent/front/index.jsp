							...
							<div class="mijoshop">
								<div class="container_oc">
									<div class="box_oc">
										...
										<c:forEach items="${hitGoods }" var="hitGoods">
										<div class="box-product product-grid">
										    <div>
										        <div class="image">
										            <a href="${pageContext.request.contextPath}/goods?method=getById&ID=${hitGoods.ID }"><img src="${pageContext.request.contextPath}/images/goods/${hitGoods.picture }" width="250px"></a>
										        </div>
										        <div class="name"><a href="${pageContext.request.contextPath}/goods?method=getById&ID=${hitGoods.ID }">${hitGoods.goodsname }</a></div>
										        <!-- 星级评分条 -->
										        <div class="rating">
												...
												<!-- 商品价格 -->
												<div class="price">
													<span class="price-new">价格：${hitGoods.nowprice }  元
													</span>
												</div>
												<!-- // 商品价格 -->
										    </div>
									...
									<div class="row">
										...
										<div class="product-grid col-lg-2 col-md-3 col-sm-6 col-xs-12">
											<div class="product-thumb transition">
												<div class="actions">
													<div class="image">
														<a href="${pageContext.request.contextPath}/goods?method=getById&ID=${newGoods.ID }">
														<img src="${pageContext.request.contextPath}/images/goods/${newGoods.picture }" alt="${newGoods.goodsname }" class="img-responsive"></a>
													</div>
												...
												<div class="caption">
													<div class="name" style="height: 40px">
														<a href="${pageContext.request.contextPath}/goods?method=getById&ID=${newGoods.ID }"> <span style="color: #0885B1">商品名：</span>  ${newGoods.goodsname }</a>
													</div>
													<div class="name" style="margin-top: 10px"><p class="price">价格：${newGoods.price }元</p></div>
												</div>
											</div>
										</div>
								        </c:forEach>
					...
					<div class="ja-tab-subcontent">
						<div class="mijoshop">
							<div class="container_oc">
								<div class="row">
									<!-- 循环显示打折商品 ：添加12条商品信息-->
									<c:forEach items="${nowGoods }" var="nowGoods">
									    <div class="product-grid col-lg-2 col-md-3 col-sm-6 col-xs-12">
									        <div class="product-thumb transition">
									            <div class="actions">
									                <div class="image">
									                    <a href="${pageContext.request.contextPath}/goods?method=getById&ID=${nowGoods.ID }">
									                        <img src="${pageContext.request.contextPath}/images/goods/${nowGoods.picture }" class="img-responsive">
									                    </a>
									                </div>
									                <div class="button-group">
									                    <div class="cart">
									            ...
									            <div class="caption">
									                <div class="name" style="height: 40px">
									                    <a href="${pageContext.request.contextPath}/goods?method=getById&ID=${nowGoods.ID }"
															style="width: 95%"> <span style="color: #0885B1">商品名：</span>${nowGoods.goodsname }</a>
									                </div>
									                <div class="name" style="margin-top: 10px">
														<span class="price"> 现价：${nowGoods.nowprice } 元</span><br> <span class="oldprice">原价：${nowGoods.price }元</span>
													</div>
									            </div>
									        </div>
									    </div>
