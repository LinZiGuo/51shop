								...
								<div class="container_oc">
									<div class="box_oc">
										...
										<div class="box-product product-grid">
											<div>
												<div class="image">
													<a href="goodsDetail.jsp?ID=<%=hot_ID%>"><img src="${pageContext.request.contextPath}/images/goods/<%=hot_picture %>" width="250px"></a>
												</div>
													...
													<div class="product-thumb transition">
														<div class="actions">
															<div class="image">
																...
																<img src="${pageContext.request.contextPath}/images/goods/<%=new_picture%>" alt="<%=new_goodsname%>" class="img-responsive"></a>
															</div>
...
%>
										...
										<div
													...
													<div class="product-thumb transition">
														<div class="actions">
															<div class="image">
																<a href="goodsDetail.jsp?ID=<%=sale_ID%>"><img src="${pageContext.request.contextPath}/images/goods/<%=s_picture %>"
																	alt="Asus/<%=s_goodsname %>" class="img-responsive"> </a>
															</div>
															<div class="button-group">
																<div class="cart">
																	<button class="btn btn-primary btn-primary" type="button" data-toggle="tooltip"
