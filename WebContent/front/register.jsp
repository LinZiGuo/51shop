			...
			<div id="mr-content" class="mr-content col-xs-12">
				<div class="login-wrap" style="margin-bottom: 60px; margin-top: 50px">
					...
					<div class="login">
						...
						<!-- 会员注册表单 -->
						<form id="member-registration" action="${pageContext.request.contextPath}/member"
							...
							<fieldset>
								...
								<div class="form-group">
									<div style="float: right; padding-right: 216px;">
										51商城<a href="${pageContext.request.contextPath}/front/agreement.html" style="color: #0885B1;">《使用条款》</a>
									</div>
								</div>
								<div class="form-group">
